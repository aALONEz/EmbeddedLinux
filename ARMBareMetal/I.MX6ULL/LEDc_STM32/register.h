...
typedef struct//定义CCM时钟相关结构体,一定要注意寄存器的连续性
{
    ...
    volatile unsigned int RESERVE_1[2];//保留,为了弥补寄存器地址之间的间隙
    volatile unsigned int CDHIPR;
    volatile unsigned int RESERVE_2[2];
    ...
    volatile unsigned int RESERVE_3[1];
